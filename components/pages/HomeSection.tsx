...
const HomeSection = () => {
    return (
        <section className="relative flex h-svh w-full items-center pt-15 lg:pt-20 justify-center overflow-hidden p-4 sm:p-8 lg:p-12">
            ...
            */}
            <main className="z-10 min-h-0 grid w-full max-w-7xl h-full lg:h-auto lg:aspect-16/10 mx-auto backdrop-blur-lg rounded-4xl p-4 gap-4 grid-cols-1 grid-rows-[3fr_1fr_1fr] lg:grid-cols-3 lg:grid-rows-4">
